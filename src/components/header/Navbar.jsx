      ...
      <div className="flex h-16 items-center justify-between gap-5">
        ...
        <div className="flex flex-1 items-center justify-end gap-5">
          ...
          <div className="relative top-[2px] ">
            <button className="h-8 w-8 rounded-full cursor-pointer" onClick={handleUsermenu}>
              <img src={user.picture} alt="img" 
                className="h-8 w-8 rounded-full object-cover"
              />
            </button>

            <div className={`z-50 ${drpusermenu ? 'fixed right-1' : 'hidden right-0'} text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-[#855E08] dark:divide-gray-600`} id="user-dropdown">
              <div className="px-4 py-3">
                <span className="block text-base sm:text-lg text-gray-900 dark:text-white">{user.name}</span>
