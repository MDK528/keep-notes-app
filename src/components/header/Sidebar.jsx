            ...
            <div className={`flex flex-col ${menubarStatus ? 'ml-0 translate-x-0' : 'ml-2 -translate-x-100 sm:translate-x-0'}`}>
                ...
                >
                    <span className={` ${menubarStatus ? 'pl-2' : 'pl-0'}`}>
                        ...
                        className='dark:fill-gray-100 fill-black h-5 w-5 sm:h-5 sm:w-5'
                        width="24" 
                        height="24" 
                        viewBox="0 0 24 24" >
                ...
                >
                    ...
                    <span className={`${menubarStatus ? '' : 'hidden'}`}>Reminders</span>
                </NavLink> 
                */}
                ...
                >
                    <span className={`${menubarStatus ? 'pl-2' : 'pl-0'}`}>
                        <svg xmlns="http://www.w3.org/2000/svg" className='dark:fill-gray-100 fill-black h-5 w-5 sm:h-5 sm:w-5' width="24" height="24" viewBox="0 0 24 24">
